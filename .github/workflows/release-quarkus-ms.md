...
|       Param      | Required | Default |     Type    | Descriprion |
| ---------------- | -------- | ------- | ----------- |------------ |
| codebuild-runner |  *YES*   |    -    |   String    | Codebuild runner name |
| native           |  *YES*   | false   |   boolean   | Represents the generated tag (triggered by "release-quarkus-ms") <br/>"release-quarkus-ms" <br/>or branch and tag selected (triggered manually) |
...
| ---------------- | -------- | -------    | ----------- |------------ |
| codebuild-runner |  *YES*   |    -       |   String    | Codebuild runner name |
| native b         | *YES*    |  false     |   boolean   | Represents the generated tag (triggered by "release-quarkus-ms") <br/>"release-quarkus-ms" <br/>or branch and tag selected (triggered manually) |
|    ref_name      |  *YES*   | github.ref |   boolean   |              |
